...
function normalize(summary, detail) {
  ...
  return {
    ...
    // The lightbox needs more pixels than the 1080px grid source. urls.full is
    // the same photo at full resolution, still hotlinked as the API requires.
    full: summary.urls.full ?? summary.urls.regular,
